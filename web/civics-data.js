...
const CIVICS = [
  ...
  { n: 12, sub: "Principles of American Government", cat: "system",
    ...
    a: ["Capitalism", "Free market economy"], star: true },
  ...
  { n: 51, sub: "System of Government", cat: "branch",
  ...
  { n: 66, sub: "Rights and Responsibilities", cat: "named",
    ...
    a: ["The United States", "The flag"], star: true },
  ...
  { n: 108, sub: "Recent American History and Other Important Historical Information", cat: "person",
    q: "Who was the United States’ main rival during the Cold War?",
    a: ["Soviet Union", "USSR", "Russia"] },
  { n: 109, sub: "Recent American History and Other Important Historical Information", cat: "war",
  ...
  { n: 117, sub: "Recent American History and Other Important Historical Information", cat: "tribe",
    ...
    a: ["Apache", "Blackfeet", "Cayuga", "Cherokee", "Cheyenne", "Chippewa", "Choctaw", "Creek", "Crow", "Hopi", "Huron", "Inupiat", "Lakota", "Mohawk", "Mohegan", "Navajo", "Oneida", "Onondaga", "Pueblo", "Seminole", "Seneca", "Shawnee", "Sioux", "Teton", "Tuscarora For a complete list of tribes, please visit bia.gov."] },
  ...
  { n: 126, sub: "Holidays", cat: "holiday", need: 3,
    ...
    a: ["New Year’s Day", "Martin Luther King, Jr. Day", "Presidents Day (Washington’s Birthday)", "Memorial Day", "Juneteenth", "Independence Day", "Labor Day", "Columbus Day", "Veterans Day", "Thanksgiving Day", "Christmas Day"], star: true },
